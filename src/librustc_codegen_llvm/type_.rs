...
impl Type {
    ...
    pub fn address_space(&self) -> AddressSpace {
        let space_number = unsafe {
            llvm::LLVMRustGetPointerTypeAddressSpace(self)
        };
        AddressSpace(space_number as u32) // TODO: change retval of ffi func to appropriate type
    }
